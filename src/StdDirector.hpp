#ifndef STDDIRECTOR_H
#define STDDIRECTOR_H

#include <iostream>
#include <fstream>

template< class Elem = char, class Tr = std::char_traits< Elem > >
class StdDirector: public std::basic_streambuf< Elem, Tr >
{
/**
* Callback Function.
*/
...
public:
    ...
    */
    StdDirector( std::ostream& a_Stream, pfncb a_Cb, void* a_pUsrData ) :
          m_Stream( a_Stream ),
          m_pCbFunc( a_Cb ),
